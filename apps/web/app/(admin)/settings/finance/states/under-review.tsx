...
export const UnderReviewState = () => {
  ...
  return (
    <div>
      <FinanceStepper activeStep="review" />
      <div className="card text-center">
        <div className="flex justify-center pb-6 pt-2">
          <PulsingDots />
        </div>
        <h2 className="display mb-2 text-2xl italic text-terra">Documentos em análise</h2>
        <p className="mx-auto mb-6 max-w-[48ch] text-[15px] text-ink-soft">
          Recebemos tudo. A análise costuma sair em até um dia útil — avisamos assim que a conta for liberada. Enquanto isso, você pode usar o Acolhe.animal normalmente.
        </p>
